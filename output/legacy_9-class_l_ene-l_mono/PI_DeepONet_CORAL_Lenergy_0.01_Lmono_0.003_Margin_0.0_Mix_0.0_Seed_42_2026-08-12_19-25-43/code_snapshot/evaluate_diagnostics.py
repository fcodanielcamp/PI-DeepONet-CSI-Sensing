...
def run_post_hoc_diagnostics(
  ...
  if not model_path.exists():
    print(
        f'⚠️ Aviso: No se encontró el modelo en {model_path} para el'
        ' diagnóstico.'
    )
    return
  ...
  # Cargar Datasets de los 3 splits (sin y_empty)[cite: 17]
  datasets = {
  ...
  print(
      '✅ Matrices de confusión (3 splits) guardadas en:'
      f" {diagnostics_dir / 'confusion_matrices_all_splits.png'}"
  )
