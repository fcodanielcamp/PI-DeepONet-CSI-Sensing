...
# ==============================================================================
# 3. FUNCIÓN DE LOSS TOTAL (Con Regularización Física Temporal)
# ==============================================================================
def compute_pi_loss(logits, latent_field, y_people, y_empty, lambda_phys=0.01, class_weights=None, lambda_temp=0.001):
    # 1. Pérdida de datos (Cross Entropy Ponderada por clase)
    ...
    # Reorganizar el campo latente a (Batch, 25 tramas, 241 subportadoras)
    batch_size = latent_field.size(0)
    latent_3d = latent_field.view(batch_size, 25, 241)
    
    # Diferencia discreta en la dimensión temporal (eje 1)
    ...
    # Retornar pérdida total y componentes desglosados
...
if __name__ == "__main__":
    ...
    if not META_PATH.exists():
        ...
        print(f"Loss Total: {loss_total.item():.4f} (Data: {loss_data.item():.4f}, Phys: {loss_phys.item():.4f}, Temp: {loss_temp.item():.4f})")
